            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="candidate-chat-messages" v-if="showModal">
                    <div class="title-area">
                        <div class="title" v-if="company" v-text="company.name"></div>
                    </div>
                    ...
                    <div class="form-single">
                        <form method="" action="" class="d-flex align-items-center" @submit.prevent="onSendCompanyMessage" style="column-gap: 5px;">
